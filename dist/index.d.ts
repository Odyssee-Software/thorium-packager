...
import { FilesMapperResult } from './file-mapper';
...
*/
export declare class _thoriumPackager implements IThoriumPackager {
    static fileMapper(sourceDir: string): ThoriumPackagerConstructor["fileMapper"];
    static initPackage(): ThoriumPackagerConstructor["initPackage"];
    static readPackage(sourcePackage: string): Promise<ThoriumPackagerConstructor["readPackage"]>;
    static writePackage(sourceToPack: string, pathToPack: string): Promise<ThoriumPackagerConstructor["writePackage"]>;
}
/**
...
*/
export declare const thoriumPackager: ThoriumPackagerConstructor;
export { FilesMapperResult, Archiver, ParseStream };
